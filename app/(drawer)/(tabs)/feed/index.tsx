...
import { StyleSheet, View, FlatList, Pressable, Alert, Text, ActivityIndicator } from 'react-native';
...
export default function FeedScreen() {
  ...
  // ** The above code is handling all of the fetching code listed below. **
